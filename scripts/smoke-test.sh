...
# Verify first pass applied all three migrations: 001-initial, 002-oidc-transactions, 003-task-tags
...
echo "First pass: All three migrations applied."
...
# Verify second pass applied nothing (no applied: lines) - all three are already applied
